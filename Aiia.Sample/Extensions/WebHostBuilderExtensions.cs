            ...
            return builder.ConfigureAppConfiguration((context, config) =>
                                                     {
                                                         ...
                                                         if (builtConfig["KEY_VAULT_NAME"].IsNullOrWhiteSpace())
                                                             return;
                                                         ...
                                                         config.AddAzureKeyVault($"https://{builtConfig["KEY_VAULT_NAME"]}.vault.azure.net/",
                                                                                 keyVaultClient,
            ...
            return builder.UseSerilog((context, configuration) =>
                                      {
                                          ...
                                          configuration.Enrich.WithProperty("Version", Assembly.GetEntryAssembly()?.GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion);
                                          ...
                                          if ((!options.Humio?.IngestToken.IsNullOrWhiteSpace() ?? false) && (!options.Humio?.IngestUrl.IsNullOrWhiteSpace() ?? false))
